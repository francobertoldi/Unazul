...
namespace SA.Audit.Tests.E2E.Fixtures;

public sealed class AuditWebAppFactory : WebApplicationFactory<SA.Audit.Api.Program>
{
    private readonly string _dbName = "AuditTestDb_" + Guid.NewGuid();
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureServices(services =>
        {
            ...
            // Add InMemory database for testing (replaces Npgsql from production config)
